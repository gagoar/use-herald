...
var require_envalid_cjs_production_min = __commonJS((exports2) => {
  ...
  var p = !(typeof process != "object" || !((a = process) == null || (s = a.versions) == null ? void 0 : s.node));
  var v = function(e2) {
    return function(t2) {
      return p ? "[" + e2 + "m" + t2 + "[0m" : t2;
    };
  };
  var d = {blue: v("34"), white: v("37"), yellow: v("33")};
  var h = d.white("================================");
  var w = function(e2) {
    var t2 = e2.errors, r2 = t2 === void 0 ? {} : t2;
    if (Object.keys(r2).length) {
      for (var n2 = [], o2 = [], i2 = 0, u2 = Object.entries(r2); i2 < u2.length; i2++) {
        var c2 = u2[i2], a2 = c2[0], s2 = c2[1];
        s2 instanceof l ? n2.push("    " + d.blue(a2) + ": " + (s2.message || "(required)")) : o2.push("    " + d.blue(a2) + ": " + ((s2 == null ? void 0 : s2.message) || "(invalid format)"));
      }
      o2.length && o2.unshift(" " + d.yellow("Invalid") + " environment variables:"), n2.length && n2.unshift(" " + d.yellow("Missing") + " environment variables:");
      var f2 = [h, o2.sort().join("\n"), n2.sort().join("\n"), d.yellow("\n Exiting with error code 1"), h].filter(function(e3) {
        return !!e3;
      }).join("\n");
      if (console.error(f2), !p)
        throw new TypeError("Environment validation failed");
      process.exit(1);
    }
  };
  var y = Symbol("envalid - test only");
  function m(e2) {
  ...
  function g(e2, t2, r2) {
    var n2;
    r2 === void 0 && (r2 = {});
    for (var o2 = {}, i2 = {}, u2 = Object.keys(t2), c2 = O(e2, "NODE_ENV"), a2 = 0, s2 = u2; a2 < s2.length; a2++) {
      var f2, p2 = s2[a2], v2 = t2[p2], d2 = c2 && c2 !== "production" && v2.hasOwnProperty("devDefault"), h2 = d2 ? v2.devDefault : void 0, g2 = (f2 = O(e2, p2)) != null ? f2 : h2 === void 0 ? v2.default : h2, x2 = v2.hasOwnProperty("default") && v2.default === g2 || d2 && h2 === g2;
      try {
        if (g2 === y)
          throw new l(b(v2));
        if (g2 === void 0) {
          ...
          o2[p2] = m({name: p2, spec: v2, rawValue: g2});
      } catch (e3) {
        var E2;
    ...
    return (((n2 = r2) == null ? void 0 : n2.reporter) || w)({errors: i2, env: o2}), o2;
  }
  var x = function(e2, t2) {
    var r2 = ["length", "inspect", "hasOwnProperty", Symbol.toStringTag, Symbol.iterator, "asymmetricMatch", "nodeType", "then", "__esModule"], n2 = ["Symbol(util.inspect.custom)", "Symbol(nodejs.util.inspect.custom)"];
  ...
  var _ = /^(([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])\.){3}([0-9]|[1-9][0-9]|1[0-9]{2}|2[0-4][0-9]|25[0-5])$/;
  var P = /([a-f0-9]+:+)+[a-f0-9]+/;
  var N = /^[^@\s]+@[^@\s]+\.[^@\s]+$/;
  var S = function(t2) {
    return function(r2) {
  ...
  exports2.EnvError = f, exports2.EnvMissingError = l, exports2.accessorMiddleware = E, exports2.applyDefaultMiddleware = j, exports2.bool = function(e2) {
    ...
    return S(function(e3) {
      if (!function(e4) {
        ...
        return !!e4.length && (_.test(e4) || P.test(e4));
      }(e3))
  ...
  }, exports2.makeValidator = S, exports2.num = function(e2) {
    return S(function(e3) {
      var t2 = +e3;
      if (Number.isNaN(t2))
  ...
  }, exports2.strictProxyMiddleware = x, exports2.testOnly = function(e2) {
    return y;
...
var require_envalid_cjs_development = __commonJS((exports2) => {
  ...
  var defaultReporter = function defaultReporter2(_ref) {
